...
<html>
    ...
    <nav id="sidebar" class=".d-none .d-sm-block">
        <div class="sidebar-header">
            <h3>PLAYER STATS <?php echo $_SESSION['counter']; ?></h3>
        </div>
        <hr />
    ...
    ?>
                <div id="main">
                    <div class="problem">
                        ...
                        <!--<div class="answer">
                            <form action="./backend/form_processing.php" action="GET" class="formToSub">
                            </form>
                        </div>-->
                    </div>
                </div>
    ...
    <!-- Creates the modal to provide end-users with more context and information to
        ...
        <div class="modal fade" id="contextModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"> Question Context</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
